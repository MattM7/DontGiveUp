class Protaginist {
  ...
  int nDirec;
  PImage img;
  Protaginist(PVector vTempPos, float fTempAccel, float fTempVelocity, int nTempVelocityLimit, boolean canTempJump, int nTempDirec) {
    vPos = vTempPos;
  ...
  boolean isHit(Protaginist hero) {
