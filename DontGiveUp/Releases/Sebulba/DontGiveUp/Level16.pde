class Level16 extends LevelBase {
  Level16() {
    ...
    LvlBase.alSaws.add(new Sprite(nBoxSize*16, nLevelHeight-8*nBoxSize, 0, 0, 0, 7, "shurikan.png", 50, 100, 0, 8, false));
    LvlBase.alSaws.add(new Sprite(nLevelWidth-3.5*nBoxSize, nLevelHeight-4*nBoxSize, 0, 0, 0, 7, "shurikan.png", 100, 100, 0, 7, false));

    LvlBase.alSaws.add(new Sprite(nLevelWidth-8*nBoxSize, nLevelHeight-4.5*nBoxSize, 0, 0, 0, 1, "shurikan.png", 100, 150, 0, 8, false));
