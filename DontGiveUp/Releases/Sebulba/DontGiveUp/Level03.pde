class Level03 extends LevelBase {
  Level03() {
    ...
    // ============== PLATFORMS =============================================
    LvlBase.alPlat.add(new Sprite (750, nLevelHeight-5*nBoxSize, 0, 0, 0, 0, "box.png", 0, 0, 0, 0, false));
    LvlBase.alPlat.add(new Sprite (700, nLevelHeight-5*nBoxSize, 0, 0, 0, 0, "box.png", 0, 0, 0, 0, false));
