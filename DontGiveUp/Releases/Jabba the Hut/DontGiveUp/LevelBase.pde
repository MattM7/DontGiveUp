...
class LevelBase {
  ...
  // ============== UPDATE BULLETS =============================================
  // something happens with arrayList, because it's an arrayList
  // if we do nI--; where commented out, it gives index out of bounds: -1
  // for now, it works if we check on boxes first and then platforms
  void updateBullets() {
    if (alBullets.size()!=0) {
