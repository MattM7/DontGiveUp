class Messages {
  ...
  void update() { 
    ...
    // "\n" is for a new line
    sMessage[0] = names.bNameIsThere? "Back for more "+names.sName+"?":"Hello there "+names.sName+".";
    sMessage[1] = names.bNameIsThere? "It's good to see you again.":"I like meeting new people.";
    ...
    sMessage[14] = "I'm sorry, I panicked on the last one.";
