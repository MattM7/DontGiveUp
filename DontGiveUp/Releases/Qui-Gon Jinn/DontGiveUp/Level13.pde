class Level13 extends LevelBase {
  Level13() {
    ...
    LvlBase.alSaws.add(new Sprite(200, nLevelHeight-1.5*nBoxSize, 0, 0, 0, 1, "shurikan.png", 75, 75, 0, 6));
    LvlBase.alSaws.add(new Sprite(nLevelWidth - 300, nLevelHeight-4*nBoxSize, 0, 0, 0, 4, "shurikan.png", 75, 75, 0, 6));
    LvlBase.alSaws.add(new Sprite(nLevelWidth - 220, nLevelHeight-2.5*nBoxSize, 0, 0, 0, 1, "shurikan.png", 75, 75, 0, 6));
