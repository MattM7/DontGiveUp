class Messages {
  ...
  void update() { 
    sMessage[0] = names.bNameIsThere? "Back for more "+names.sName+"?":"Welcome "+names.sName+".";
    sMessage[1] = names.bNameIsThere? "Good to see you again.":"It's nice meeting new people.";
    sMessage[2] = "This level is pretty tricky.";
    sMessage[3] = names.bNameIsThere? "Don't die."+names.sName:"Don't die.";
    sMessage[4] = "Wow. That was pure luck.";
    sMessage[5] = "So much Gore, eh?.";
    sMessage[5] = " ";
    sMessage[6] = " ";
    sMessage[7] = " ";
    sMessage[8] = " ";
