// Release 6.6 - R2D2 - moving spikes and 6 more levels!

// LEVEL 17 HAS TO BE FIXED
...
void setup() {
  ...
  entry = new Sprite (nBoxSize, nLevelHeight-nBoxSize-75, 0, 0, 0, 0, "entryDoor.png", 0, 0, 0, 0, false); //75 for height of the door 
  exit = new Sprite (nLevelWidth-nBoxSize-48, nLevelHeight-nBoxSize-75, 0, 0, 0, 0, "exitDoor.png", 0, 0, 0, 0, false); // 48 for width of the door
  sprHero = new Sprite (nBoxSize + 2, nLevelHeight - nBoxSize*2, 1.6, 0.6, 16, 0, "PixelCrab.png", 0, 0, 0, 6, false); //construct a sprHero // to fix the lag had to change from 0.8 to 1.6, 0.3 to 0.6, 8 to 16 
  ...
  names = new Name();
  menu = new Menu();
  sprSidekick = new Sprite (nBoxSize, nLevelHeight - nBoxSize*3, 0, 0, 0, 0, "butterfly.png", 0, 0, 0, 0, false);
  window = new Window();
